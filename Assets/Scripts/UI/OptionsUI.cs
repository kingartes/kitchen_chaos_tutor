...
public class OptionsUI : MonoBehaviour
{
    ...
    [SerializeField]
    private Button inteactAltButton;
    [SerializeField]
    ...
    [SerializeField]
    private TextMeshProUGUI interactionAltText;
    [SerializeField]
    private TextMeshProUGUI pauseText;
    #endregion

    [SerializeField]
    private Transform pressToRebindTransform;
    ...
    private void Awake()
    {
        ...
        inteactAltButton.onClick.AddListener(() =>
        {
    ...
    private void UpdateVisual()
    {
        ...
        interactionAltText.text = GameInput.Instance.GetBindingText(GameInput.Binding.Interact_Alternative);
